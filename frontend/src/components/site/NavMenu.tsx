...
const columns: Item[][] = [
  ...
  [
    ...
    { label: "Olímpia quer sua opinião!!", icon: MessageSquare },
    {
      label: "Política de acesso dos munícipes aos atrativos turísticos",
      icon: ShieldCheck,
    },
  ],
  [
    ...
    { label: "Perfil do Turista", icon: Star},
  ],
];
            ...
            <ul className="space-y-2 pl-1">
              {sideItems.map((item) => (
                <li key={item.label}>
                  <a
                    href="#"
                    className="flex w-full items-center gap-3 px-3 py-2 text-sm uppercase tracking-wide text-nav-foreground/90 transition-colors hover:bg-brand-red hover:text-white"
                  >
            ...
            <ul key={i} className="space-y-2">
              {col.map((item) => (
                <li key={item.label}>
                  <a
                    href="#"
                    className="flex w-full items-start gap-3 px-3 py-2 text-sm uppercase leading-tight tracking-wide text-nav-foreground/90 transition-colors hover:bg-brand-red hover:text-white"
                  >
